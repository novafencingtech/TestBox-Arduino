...
class Adafruit_SSD1351 : public Adafruit_SPITFT {
  public:
    ...
    void begin(uint32_t freq = 0),
         ...
         setHorizontalScroll(bool enable, uint8_t dir, uint8_t startRow,uint8_t numRows,uint8_t scrollSpeed),
         setDisplayStartLine(uint8_t val),
         setDisplayOffset(uint8_t val),
         setMuxRatio(uint8_t val);
};
